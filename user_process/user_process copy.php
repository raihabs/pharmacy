    ...
    if (!in_array($imageExtension, $validImageExtension)) { ?>
        ...
        <script>
            Swal.fire({
                ...
                .then(function() {
                    document.location.href = '../user/user_profile_settings.php';
                });
        </script>
...
if (isset($_POST['del_id'])) {
    ...
    $query_delete = "UPDATE  `user` WHERE `user_id` = '" . $del_id . "'";
...
if (isset($_POST['valid_account'])) {
    ...
    if ($username == "" || $firstname == "" || $lastname == "" || $email == "" || $phone2 == "" || $address == "" || $birthday == "" || $password == "") {
        ...
        if (mysqli_num_rows($res_username) > 0) {
            ...
            $query_add_user = "INSERT INTO `user` (`username`,`firstname`, `lastname`,`email`,`phone`,`address`,`birthday`,`password`,`role`,`session_attempt`,`created_by`,`date_created_at`) VALUE ('$username','$firstname','$lastname','$email','$phone','$address','$birthday','$hash_password','$role', 1, '$user_id','$date_created_at')";
...
if (isset($_POST['update_account'])) {
    ...
    $update_user_id = mysqli_real_escape_string($conn, $_POST['update_user_id']);
    $username = mysqli_real_escape_string($conn, $_POST['username']);
...
if (isset($_POST['user_Password'])) {
    ...
    if ($admin_password == "" || $user_password == "") {
        ...
        $user_id = $_POST['u_id'];
        $p_user_id = mysqli_real_escape_string($conn, $_POST['p_user_id']);
