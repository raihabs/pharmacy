...
if (isset($_SESSION['checkUser']) || isset($_SESSION['verify_email']) || isset($_SESSION['verify_code']) || isset($_SESSION['resend_email']) || isset($_SESSION['resend_code']) || isset($_SESSION['email_reset'])) {
...
<body>
    ...
    <div class="login-wrap">
        ...
        <!-- <span class="login100-form-left-background">
            <img src="../assets/images/default_images/med.png" class="pharmacy" alt="" width="50%" height="80">
        </span> -->
        ...
        <div class="login-card">
            ...
            <form id="login_form" class="login100-form validate-form">
                ...
                <div class="form">
                    ...
                    ,
                    <div id="container">
                        <h5><a class="txt2" href="/pharmacy/usersignin/reset-page.php">Reset Password/Forgot Password</a></h5>
                    </div>
                </div>
            </form>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.success == 100) {
                        ...
                        setTimeout(function() {
                            location.href = '/pharmacy/admin/admin.php';
                        }, 5000);
                        ...
                        showProgressBar(res.message);
                        setTimeout(function() {
                            location.href = '/pharmacy/cashier/sales.php';
                        }, 5000);
                        ...
                        showProgressBar(res.message);
                        setTimeout(function() {
                            location.href = '/pharmacy/inventory_clerk/physical_inventory.php';
                        }, 5000);
