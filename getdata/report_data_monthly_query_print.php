...
<body>
    <div id="reportsTitle">
        ...
        <div class="row">
            ...
            ?>
            <h5 style="font-size: 16px; font-weight: 800; margin:0; text-align: left;">Monthly Business Overview</h5>
            <p class="text-muted" style="font-size: 15px; font-weight: 600; text-align: left;"> Show overview jan <?= $last_month['month_year'] ?>-<?= $first_month['month_year'] ?> <?= $last_month['year_now'] ?>
            </p>
        </div>
...
$total_sales = mysqli_fetch_array($total_sales_result);
                ?> -->
                <h5 class="d-inline-block survey-value mb-0" style="font-size: 14px; font-weight: 800; margin: 0; text-align: left;">₱<?= $last_month['monthly_total'] ? $last_month['monthly_total'] : '0' ?>.<span class="h5">00</span></h5>
