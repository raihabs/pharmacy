...
<body>
    <div style="display: flex;justify-content: center;align-items: center;flex-direction: column;height: 100%; text-align: center;left: 125px;">
        <img src="C:\xampp\htdocs\pharmacy\assets\images\default_images\brindox.png" width='100' height='100' style="border-radius: 50%; border: 0; object-fit: cover; display: flex;justify-content: center;align-items: center;flex-direction: column;height: 100%; text-align: center;left: 425px;" />
    ...
    <table>
        ...
        <tbody>
            ...
            FROM product p LEFT JOIN archive a ON p.pr_id = a.pr_id WHERE a.quantity <= 30 OR a.remarks != 'ACTIVE' ORDER BY a.pr_id DESC";
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo $product["image"] ? $product["image"] : 'N/A' ?></td>
