...
<body>
    ...
    FROM product p LEFT JOIN sale s ON p.pr_id = s.pr_id WHERE sa_id != '' AND s.date_created_at >= DATE_SUB(CURDATE(), INTERVAL 3 MONTH) GROUP BY s.sales_code ORDER BY s.date_created_at DESC;";
