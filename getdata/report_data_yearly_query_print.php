...
ORDER BY 
    YEAR(date_created_at) ASC";
            ...
            ?>
            <h5 style="font-size: 16px; font-weight: 800; margin:0; text-align: left;">Yearly Business Overview</h5>
            <p class="text-muted" style="font-size: 15px; font-weight: 600; text-align: left;"> Show overview from <?= $last_month['month_year'] ?>-<?= $first_month['month_year'] ?> <?= $last_month['year_now'] ?>
            </p>
        </div>
    ...
    <div id="reportsTitle1">
        <div class="row">
            <div class="col-sm-8">
                <p class="text-muted mb-0" style="font-size: 14px; font-weight: 800; margin: 30px 0 20px 0; text-align: left;"> This report will return the sum of the total for each year in the past six months, including the current month.
                </p>
            </div>
            ...
            <div class="col-sm-4">
                ...
                <p class="d-inline-block text-danger mb-0" style="font-size: 14px; font-weight: 800; margin:0; text-align: left;"> last 12 months </p>
...
GROUP BY 
    YEAR(date_created_at)        -- Group by year and month
ORDER BY 
    YEAR(date_created_at) ASC      -- Order by year and month
";
