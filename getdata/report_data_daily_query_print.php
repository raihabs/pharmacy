...
WHERE 
status = 'RELEASED'
AND date_created_at >= DATE_SUB(CURDATE(), INTERVAL 8 DAY)
GROUP BY 
    ...
    <div id="reportsTitle1">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p class="d-inline-block text-danger mb-0" style="font-size: 14px; font-weight: 800; margin:0; text-align: left;"> last 8 DAYs </p>
