<table class="table" id="table">
    ...
    FROM product p LEFT JOIN archive a ON p.pr_id = a.pr_id WHERE  a.remarks = 'EXPIRED' AND a.date_updated_at IS NOT NULL ORDER BY  a.date_created_at DESC, a.date_updated_at DESC";
