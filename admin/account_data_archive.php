<table class="table" id="table_archive">
    <thead>
        <tr>
            <th>User Name</th>
            <th>First Name</th>
    ...
    <tbody>
        ...
        $sessionId = $id;
        $user_list_query = "SELECT * FROM `user` WHERE `user_id` != $sessionId  && `status` = 'INACTIVE' ORDER BY `user_id` DESC";
                ...
                <tr>
                    ...
                    <td>
                        <div class="action">
                            ...
                            <button class="btn btn-danger btn-sm m-b-10 account_delete2 button2" data-role="update" id="<?php echo $row['user_id']; ?>" style="background-color: #8B4513; border-color: red;"><i class='mdi mdi-archive' style="color: #fff; font-size: 20px;"></i></button>
                        </div>
                    </td>
                </tr>
        <?php
